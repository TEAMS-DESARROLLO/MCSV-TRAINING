...
public interface IAssignedCourseRegistrationMapper {
	...
	@Mapping(source = "idRegisterFollow.idRegisterFollow", target = "idRegisterFollow")
	AssignedCourseRegistrationResponseDTO toGetDTO(AssignedCourseRegistration assignedCourseRegistrationEntity);
	
	@InheritInverseConfiguration
	@Mapping(source = "idRegisterFollow", target = "idRegisterFollow.idRegisterFollow")
	...
	List<AssignedCourseRegistrationResponseDTO> listEntityToDto(List<AssignedCourseRegistration> tipoVias);
